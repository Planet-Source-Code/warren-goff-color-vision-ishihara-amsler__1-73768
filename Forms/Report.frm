...
Dim i As Integer
For i = 1 To 16
    Label2(i).Caption = Ishahara.List4.List(i - 1)
Next
Label3.Caption = Reported
CandyButton1.Style = 2
End Sub

Private Sub Label2_Change(Index As Integer)
'Label2(Index).Caption = Replace(Label2(Index).Caption, "0", "|")
If Label2(Index).Caption = "0" Then Label2(Index).Caption = "X"
End Sub
